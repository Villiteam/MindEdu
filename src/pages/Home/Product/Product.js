    ...
    return (
        <div className='product' id='tinh-nang'>
            <div className='product__title'>
                ...
                <p>
                    Với MindEdu, giáo viên dễ dàng giảm tải công việc hàng ngày, tăng hiệu quả giảng dạy và có thể nắm bắt năng lực của học sinh một cách nhanh chóng.
                </p>
            </div>
